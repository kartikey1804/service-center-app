...
class MainScaffoldState extends State<MainScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: [
            ...
            Text(
              Provider.of<DataProvider>(context).storeName,
              style: TextStyle(
      ...
      bottomNavigationBar: (isCustomer || !isDesktop)
          ? _buildBottomNav(user.role)
          : null,
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: const Text(
                      'I have a question about my recent service quote.',
                    ),
                  ),
                ),
              ],
  ...
  Widget _buildBody(UserRole role) {
    if (role == UserRole.customer) {
      switch (_currentIndex) {
        ...
        case 2:
          return const CustomerGarage();
        case 3:
          return const ServiceHistory();
        default:
          return const CustomerDashboard();
      }
    }
    if (role == UserRole.technician) {
      switch (_currentIndex) {
        case 0:
          return const TechDashboard();
        case 1:
          return const TechJobBoard();
        default:
          return const TechDashboard();
      }
    }
    if (role == UserRole.manager) {
      switch (_currentIndex) {
        ...
        case 1:
          return const StaffAttendance();
        case 2:
          return const ActiveJobsList();
        default:
          return const ManagerDashboard();
      }
    }
    if (role == UserRole.admin) {
      switch (_currentIndex) {
        ...
        case 3:
          return const HqAnalytics(); // Using HQ Analytics as Settings for now
        default:
          return const ManagerDashboard();
      }
    }
    ...
    return Center(
      child: Text(
        'Dashboard for ${role.name.toUpperCase()} - Tab $_currentIndex',
      ),
    );
  }
    ...
    switch (role) {
      ...
      case UserRole.admin:
        return [
          ...
          _NavItem(LucideIcons.users, 'Employees'),
      ...
      case UserRole.owner:
        return [
          ...
          _NavItem(LucideIcons.users, 'Management'),
        ];
    }
  }
}
